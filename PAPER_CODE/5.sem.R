...
.topo_bga <- read_csv("PAPER_DATA/script_output/bga.csv")
...
data <- left_join(.topo_bga, .flux, by = c("SiteCode" = "site")) %>% 
...
save(fit_final, file = ("PAPER_DATA/script_output/fit_final.RData"))
