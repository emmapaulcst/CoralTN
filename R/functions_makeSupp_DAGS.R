make_DAGS <- function(){
  ...
  export_graph(graphDAG, file_name = "PAPER_FIGS/final_figures/Supp4/Supp4_DAG1.pdf", file_type = "pdf",
  ...
  export_graph(graphDAG, file_name = "PAPER_FIGS/final_figures/Supp4/Supp4_DAG2.pdf", file_type = "pdf",
               width = 250) # width in pixel, 696 pi = 7.25 inches
  ...
  export_graph(graphDAG, file_name = "PAPER_FIGS/final_figures/Supp4/Supp4_DAG3.pdf", file_type = "pdf",
